...
const ForgotPasswordPage = () => {
  ...
  const { isLoading, userforgotpassword } = useAuthStore();
  ...
  return (
    ...
    >
      <div className="p-8">
        <p className="text-3xl font-bold mb-6 text-center bg-linear-to-r from-green-400 to-emerald-500 text-transparent bg-clip-text">
          Forgot Password
        </p>

        {!isSubmitted ? (
          <form onSubmit={handleSubmit}>
            <p className="text-gray-300 mb-6 text-center pb-5">
